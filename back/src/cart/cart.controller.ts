...
export class CartController {
  ...
  @ApiResponse({ status: 200, description: 'Return user cart', type: CartWithTotalsDto })
  ...
  @ApiResponse({ status: 200, description: 'Item added to cart', type: CartWithTotalsDto })
  async addToCart(
    @Request() req,
  ...
  @ApiResponse({ status: 200, description: 'Cart item updated', type: CartWithTotalsDto })
  ...
  @ApiResponse({ status: 200, description: 'Item removed from cart', type: CartWithTotalsDto })
  ...
  @ApiResponse({ status: 200, description: 'Cart cleared', type: CartWithTotalsDto })
